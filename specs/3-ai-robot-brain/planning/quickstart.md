...
This guide provides a quick overview of how to develop and contribute to the AI-Robot Brain module for the Physical AI & Humanoid Robotics book.

## Prerequisites

- Basic understanding of robotics concepts
- Familiarity with Docusaurus documentation system
- Access to official NVIDIA Isaac documentation for reference
...
1. **Content Structure**:
   - Chapters are organized in `frontend_book/docs/ai-robot-brain/`
...
2. **Writing Style**:
   ...
   - Emphasize system-level concepts and integration
...
- `frontend_book/docs/ai-robot-brain/`: Main directory for AI-Robot Brain content
- `frontend_book/docs/ai-robot-brain/_category_.json`: Category configuration
- Individual chapter files: `introduction.md`, `isaac-sim.md`, `isaac-ros.md`, `nav2-navigation.md`
...
1. **Creating a New Chapter**:
   - Add new Markdown file in the ai-robot-brain directory
